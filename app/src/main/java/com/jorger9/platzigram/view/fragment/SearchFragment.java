...
import com.jorger9.platzigram.tools.GridSpacingItemDecoration;
...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView picturesRecycler = (RecyclerView) view.findViewById(R.id.picturesSearchRecycler);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(),2);
        gridLayoutManager.setOrientation(gridLayoutManager.VERTICAL);

        int spacingInPixels = getResources().getDimensionPixelSize(R.dimen.grid_layout_margin);
        picturesRecycler.addItemDecoration(new GridSpacingItemDecoration(2, spacingInPixels, true, 0));
